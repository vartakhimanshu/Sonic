...
class World {
  ...
  public:
	...
	World(const Location& loc, const Velocity& vel, float bear) : player(loc,vel,bear), numObj(0), threshold(0.05) {}
	...
	// by the parameter.
	int addAudioObj(const Location& loc, const Velocity& vel);
