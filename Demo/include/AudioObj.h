...
public:
    ...
    AudioObj(const std::string wavFileName, int Azi, int ele):active(false), volume(1), repeat(true), circBuff(BUFFER_CAPACITY), wavObject(BUFFER_CAPACITY, wavFileName, BUFFER_CAPACITY), Azimuth(Azi), elevation(ele)
    {
